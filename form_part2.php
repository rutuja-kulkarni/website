<?php
	...
	//	if(!preg_match("/^[a-zA-Z'-]+$/",$address)) { die ("invalid");} 
		...
		'sub5'=>$sub5, 'sub6'=>$sub6, 'total1'=>$total1, 'seatno_bcom'=>$examnob2, 'boardnmb2'=>$boardnmb2, 'sub_bcom2'=>$sub11,'marksb2'=>$marksb2, 'sub22'=>$sub22, 
		'sub33'=>$sub33, 'sub44'=>$sub44, 'sub55'=>$sub55, 'sub66'=>$sub66, 'total2'=>$total2, 'sub_selected_grp1_1'=>$select11, 'sub_selected_grp1_2'=>$select12,
		'sub_selected_grp2_1'=>$select21,  	'date'=>$date, 'mobile'=>$mob, 'name_of_guardian'=>$nameG, 'occupation'=>$occ, 'income'=>$income,
        ...
        $manager->executeBulkWrite('chintamanrao.form_part2', $bulk);
    } 
?>
...
<th>Marks Obtained: Outof Total Marks</th>
  ...
  <p>Choice of optional subjects:</br>
		<strong>B.com Part I</strong> (tick each subject from each group)
		</br>1.<select name="select11" required>
  <option value="Marathi">Marathi</option>
  <option value="Principles of Marketing">Principles of Marketing</option>
</select> &nbsp &nbsp
2.<select name="select12" required>
...
<strong>B.com Part II</strong> (tick each subject from each group)
<select name="select21" required>
  <option value="Advanced Accountancy Paper I and II">Advanced Accountancy Paper I and II</option>
  <option value="Advance Costing Paper I and II">Advance Costing Paper I and II</option>
  <option value="Advanced Banking Paper I and II">Advanced Banking Paper I and II</option>
  </select>		 
</br></br></br>
<p>Date:&nbsp <input type="text" name="date" size="25" required> &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp  Mobile No.<input type="text" name="mob" maxlength="10"  pattern="[0-9]{10}" title="Enter your mobile number" required  >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Signature of Student
...
<p>Occupation:&nbsp <input type="text" name="occ" size="20" required>&nbsp Annual Income Rs. &nbsp <input type="text" name="income" size="20" required>&nbsp No. of dependents:&nbsp <input type="number" name="dep" min="0" step="1"/ required> &nbsp Phone no.&nbsp <input type="text" name="ph" size="20" required>
...
and to see that he/she observes all the rules of discipline.I request you to admit my ward to B.com Part <input type="text" name="byear" size="20" required>in your college.
...
<p>Admitted to B.com Part &nbsp <input type="text" name="prt" size="25" >&nbsp &nbsp &nbsp &nbsp
...
<div>
	 <ul class="pager">
    <li><a href="form_part1.php">Previous</a></li>
  </ul>
</div>
</br></br></br></br>
