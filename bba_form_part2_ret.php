<?php
    ...
    $cursor = $manager->executeQuery('chintamanrao.bba_form_part2', $query);
    ...
    foreach($cursor as $item){
        ...
        echo '<p> Subjects B.B.A part1:' . $item['sub'] . '</p>';
        echo '<p> marks/out of:' . $item['marks'] . '</p>';
		echo '<p> Exam seat no. & year of passing bba 1:' . $item['examnob1'] . '</p>';
		echo '<p> Name of board/university:' . $item['boardnmb1'] . '</p>';
		echo '<p> Subject 1:' . $item['sub_bcom1'] . '</p>';
		echo '<p> marks/out of -bba1:' . $item['marksb1'] . '</p>';
		...
		echo '<p> subjects bba2:' . $item['sub_bcom2'] . '</p>';
		echo '<p> marks/out of -bba2:' . $item['marksb2'] . '</p>';
		...
		echo '<p> bba year:' . $item['bcom_year'] . '</p>';
		echo '<p> date:' . $item['date'] . '</p>';
		echo '<p> mobile:' . $item['mobile'] . '</p>';
		echo '<p> bba_part:' . $item['bcom_part'] . '</p>';
