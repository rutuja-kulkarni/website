<?php
	...
	//	if(isset($_POST['subform'])) {
        ...
        //Count number of rows to assign id
            ...
            $cursor = $manager->executeQuery('chintamanrao.bba_form_part3', $query);
            $cursor->setTypeMap(['root' => 'array', 'document' => 'array', 'array' => 'array']);
            $arr=$cursor->toArray();
            $cn=count($arr)+1;
        $bulk = new MongoDB\Driver\BulkWrite;
        $bulk->insert(['_id'=>$cn,'seatno' =>$examno, 'board/university' =>$boardnm, 'sub'=>$sub, 'marks'=>$marks, 'examnob1'=>$examnob1, 
		...
		'rollno'=>$roll, 'date'=>$dat,'bba' =>$bcom, 'receipt' =>$receipt, 'year'=>$year, 'division'=>$division, 'date'=>$date, 
       ...
       // $manager->executeBulkWrite('chintamanrao.bba_form_part1', $bulk);			
        ...
        $manager->executeBulkWrite('chintamanrao.bba_form_part3', $bulk);
	}
?>
...
<th>Marks Obtained: Outof Total Marks</th>
    ...
    <tbody>
      <tr>
        <td>H.S.C</td>
        <td><input type="text" name="examno" class="form-control" id="usr"></td>
        <td><input type="text" name="boardnm" class="form-control" id="usr"></td>
	<td><input type="text" name="sub" class="form-control" id="usr"></td>
	<td><input type="text" name="marks" class="form-control" id="usr"></td>
	</tr>
     <tr>
        <td>B.B.A Part I</td>
        <td><input type="text" name="examnob1" class="form-control" id="usr"></td>
	<td><input type="text" name="boardnmb1" class="form-control" id="usr"></td>
        <td><input type="text" name="sub1" value="1." class="form-control" id="usr"></td>
	<td><input type="text" name="marksb1" class="form-control" id="usr"></td>
	...
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub2" value="2." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub3" value="3." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub4" value="4." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub5" value="5." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub6" value="6." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	  ...
	  <tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub7" value="7." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	...
	<td>Total</td>
	<td><input type="text"  name="subtot1" class="form-control" id="usr"></td>
      </tr>

	
      <tr>
        <td>B.B.A Part II</td>
        <td><input type="text" name="examnob2" class="form-control" id="usr"></td>
	<td><input type="text" name="boardnmb2" class="form-control" id="usr"></td>
        <td><input type="text" name="sub11" value="1." class="form-control" id="usr"></td>
	<td><input type="text" name="marksb2" class="form-control" id="usr"></td>
	...
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub22" value="2." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub33" value="3." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub44" value="4." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub55" value="5." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	<tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub66" value="6." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	  ...
	  <tr>
        ...
        <td></td>
	<td></td>
        <td><input type="text" name="sub77" value="7." class="form-control" id="usr"></td>
	<td></td>
	<td></td>
      </tr>
	...
	<td>Total</td>
	<td><input type="text"  name="subtot2" class="form-control" id="usr"></td>
      </tr>
...
<p>Date:&nbsp <input type="text" name="date" size="25" required> &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp  Mobile No.<input type="text" maxlength="10"  pattern="[0-9]{10}" title="Enter your mobile number" name="mob" required >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Signature of Student
...
<p>Occupation:&nbsp <input type="text" name="occ" size="20" required>&nbsp Annual Income Rs. &nbsp <input type="text" name="income" size="20" required>&nbsp No. of dependents:&nbsp <input type="text" name="dep" size="20" required >&nbsp Phone no.&nbsp <input type="text" name="ph" size="20">
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp 
 Mobile No.<input type="text" name="mobno" maxlength="10"  pattern="[0-9]{10}" title="Enter your mobile number" required >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Signature of Guardian
