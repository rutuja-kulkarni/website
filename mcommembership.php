<?php
    if(isset($_POST['submit1'])) {
        ...
        $manager->executeBulkWrite('chintamanrao.mcommember', $bulk);
    } 
?>
...
.container label,p{
	...
	<head>
	  <meta charset="utf-8"/>
	  <title>MCOM Membership Form</title>
	...
	<body>
		<div class="container" style="margin-left:12%;margin-right:10%;	background-color:#9999ff;border:9px ridge red;width:1300px">
				...
				<div class="main">
					<h2 style="font-style:bold;margin-left:17%;margin-top:4%">Chintamanrao College of Commerce,Sangli Sr.College   M.Com.I/II</h2>
