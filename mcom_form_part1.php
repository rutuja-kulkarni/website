<?php
    if(isset($_POST['subform'])) {
		...
		//	if(!preg_match("/^[a-zA-Z'-]+$/",$peraddress)) { die ("invalid");} 
        ...
        $bulk->insert(['bcom' =>$bcom, 'receipt' =>$receipt, 'year'=>$year, 'division'=>$division, 'date'=>$date, 
        ...
        $manager->executeBulkWrite('chintamanrao.mcom_form_part1', $bulk);
    } 
?>
...
<table class="table">
  <form action="" method="post" enctype="multipart/form-data">  
    <tbody>
      <tr>
        <td>M.com<input type="text" name="Bcom" class="form-control" id="usr"></td>
...
<div>
	...
	<h3 class="text-center"><strong>Application for Admission to M.Com Part I/II</strong></h3>
</div>
<div>
<p>To,</br>
    ...
    Chintamanrao College of Commerce,Sangli.</br>
	 ...
	 <p style="margin-left: 40px">At the desire of my guardian, I the undersigned, hereby apply for admission to M.com
...
Date Of Birth:<input type="date" name="dob" required> Place Of Birth:&nbsp <input type="text" name="pob" size="25" required >&nbspMarried/Unmarried:&nbsp <input type="text" name="status" size="25" required>&nbsp 
...
<p>Year:<input type="text" name="year1" size="20" required >&nbsp Div:&nbsp <input type="text" name="div" size="20" required>&nbspRoll No.&nbsp <input type="text" name="roll" size="20" required>&nbsp Blood Group&nbsp <input type="text" name="blood" size="20" required>
</div><hr>
<div>
...
<div>
    ...
    <li><a href="mcom_form_part2.php">Next</a></li>
  </ul>
</div>
</form>
